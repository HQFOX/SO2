...
public class ShoppingServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (do_this == null) {
            ...
            if (do_this.equals("checkout")) {
                ...
                request.setAttribute("dollars", new Float(dollars).toString());
                request.setAttribute("books", new Integer(books).toString());
                ...
                else if (do_this.equals("add")) {   // COMPRAR N UNIDADES DO LIVRO
                    boolean found = false;
    ...
    /**
     * Método que forma um objeto Book
     * pelo texto submetido no campo book
     * Esse campo tem título e preço numa só string - NÃO RECOMENDADO
     * 
     * ESSES DADOS ESTARIAM do lado do servidor, mas neste exemplo não temos
     * Base de Dados a apoiar a Aplicação ***
     * 
     * @param req
     * @return 
     */
